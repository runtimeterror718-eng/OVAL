...
export function AudienceIntelligenceOverview() {
  ...
  return <main className="audience-studio ai-overview-page">
    ...
    <header className="ai-topbar">
      ...
      <nav className="ai-source-nav" aria-label="Intelligence channels"><button className="active">Overview</button>{overviewSources.map((source) => <button key={source} onClick={() => openSource(source)}>{SOURCES[source].label}</button>)}</nav>
