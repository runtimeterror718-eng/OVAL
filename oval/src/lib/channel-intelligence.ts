...
export const BUSINESS_TOPIC_RULES: TopicRule[] = [
  ...
  { id: "access", name: "Access, login and entitlement", owner: "Aditya Kumar", severity: "high", sentiment: "negative", keywords: ["access", "login", "locked", "otp", "account", "subscription", "not opening", "cannot see", "paid but"] },
  { id: "payment", name: "Payments, refunds and fee trust", owner: "Aayush", severity: "critical", sentiment: "negative", keywords: ["refund", "payment", "paid", "money", "amount deducted", "upi", "fee", "fees", "transaction", "invoice"] },
  ...
  { id: "delivery", name: "Orders, delivery and study material", owner: "Store Ops", severity: "high", sentiment: "negative", keywords: ["order", "delivery", "book", "module", "kit", "tracking", "shipment", "parcel", "wrong product", "address"] },
  { id: "video", name: "Video, app and study-flow reliability", owner: "Product Reliability", severity: "high", sentiment: "negative", keywords: ["video", "playback", "buffer", "lecture", "download", "quality", "app", "slow", "lag", "loading", "not working"] },
  { id: "content", name: "Teacher, content and academic quality", owner: "Academic Ops", severity: "medium", sentiment: "mixed", keywords: ["teacher", "faculty", "sir", "mam", "lecture", "content", "concept", "class", "quality", "irrelevant"] },
  { id: "batch", name: "Batch, course and test operations", owner: "Aditya Kumar", severity: "medium", sentiment: "mixed", keywords: ["batch", "course", "test", "dpp", "planner", "validity", "arjuna", "lakshya", "yakeen", "prayas", "neet", "jee"] },
  { id: "support", name: "Support response and resolution gap", owner: "Support Ops", severity: "high", sentiment: "negative", keywords: ["support", "customer care", "response", "resolve", "complaint", "help", "ticket", "call", "contact"] },
  { id: "trust", name: "Trust, scam and reputation risk", owner: "PR + Legal", severity: "critical", sentiment: "negative", keywords: ["scam", "fraud", "fake", "controversy", "consumer", "court", "legal", "exposed", "cheat"] },
  { id: "competitor", name: "Competitor comparison and switching", owner: "Strategy", severity: "medium", sentiment: "mixed", keywords: ["allen", "unacademy", "vedantu", "competishun", "apni kaksha", "switch", "better than", "vs "] },
